        ...
        <div className="card__container">
            ...
            return(
                ...
                <div
                    ...
                    className="card" key={val.link}>
                    <div className="card__content"
                        // onClick={openLink(val.link)}
                    >

                <h3 className="card__header">{val.company}</h3>
                        <h5 className="card__header2"
                            onClick={() => window.open(val.link, "_blank")}>{val.title}</h5>
                        <Container style={{ width: "75%" }}>
                                        <ProgressBar
                                            
                                            progressColor={"purple"}
                                            
                                            score={Math.round(val.simscore)} />
                                    </Container >
